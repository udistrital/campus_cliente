...
export const Config = {
  ...
  PREPROD: {
    ...
    CAMPUS_MID: 'https://autenticacion.udistrital.edu.co/apioas/mid/v1/',
    ...
    PRODUCCION_ACADEMICA_SERVICE: 'https://autenticacion.udistrital.edu.co/apioas/produccion_academica/v1/',
    ...
    UBICACIONES_SERVICE: 'https://autenticacion.udistrital.edu.co/apioas/ubicacion/v1/',
